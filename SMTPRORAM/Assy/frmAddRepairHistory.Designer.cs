...
{
	partial class frmAddRepairIssueByLine
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.Name = "frmAddRepairIssueByLine";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "LỊCH SỬ SỬA CHỮA KHÔNG CÔNG ĐOẠN";
			this.Load += new System.EventHandler(this.frmAddRepairIssueByLine_Load);
